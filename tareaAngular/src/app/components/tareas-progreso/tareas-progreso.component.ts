...
@Component({
  selector: 'app-tareas-progreso',
  standalone: true,
  imports: [NgStyle,MaterialModule,CommonModule],
  templateUrl: './tareas-progreso.component.html',
  styleUrl: './tareas-progreso.component.css'
})
export class TareasProgresoComponent {
...
private serv_client = inject(TareasService);
  ...
  mostrarTareas():void{
   this.serv_client.getTareasEstado("progreso").subscribe(
     res=>{
